...
class MyFirstPlugin:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'MyFirstPlugin_{}.qm'.format(locale))
        ...
        self.dlg = MyFirstPluginDialog()

        # Declare instance attributes
        self.actions = []
        self.menu = self.tr(u'&My 1st Plugin')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'MyFirstPlugin')
        self.toolbar.setObjectName(u'MyFirstPlugin')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('MyFirstPlugin', message)
    ...
    def initGui(self):
        ...
        self.add_action(
            icon_path,
            text=self.tr(u'My first plugin'),
            callback=self.run,
