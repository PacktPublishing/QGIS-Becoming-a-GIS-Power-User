...
from my_first_map_tool_dialog import MyFirstMapToolDialog
import os.path
...
class MyFirstMapTool:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'MyFirstMapTool_{}.qm'.format(locale))
        ...
        self.dlg = MyFirstMapToolDialog()

        # Declare instance attributes
        self.actions = []
        self.menu = self.tr(u'&My 1st Map Tool')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'MyFirstMapTool')
        self.toolbar.setObjectName(u'MyFirstMapTool')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('MyFirstMapTool', message)
