...
<qgis version="2.3.0-Master" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <edittypes>
    <edittype labelontop="0" editable="1" name="cat"/>
    <edittype labelontop="0" editable="1" name="AREA"/>
    <edittype labelontop="0" editable="1" name="PERIMETER"/>
    <edittype labelontop="0" editable="1" name="FULL_HYDRO"/>
    <edittype labelontop="0" editable="1" name="FULL_HYDR2"/>
    <edittype labelontop="0" editable="1" name="FTYPE"/>
    <edittype labelontop="0" editable="1" name="FCODE"/>
