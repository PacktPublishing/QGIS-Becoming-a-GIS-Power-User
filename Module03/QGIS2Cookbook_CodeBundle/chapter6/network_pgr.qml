...
<qgis version="2.5.0-Master" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="reverse_co">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{a2120f09-2250-455e-8489-1585b2f7fc27}">
      <rule filter="&quot;dir&quot; = 'FT' " key="{68937e5c-f089-4729-bc3a-ff6abcded152}" symbol="0"/>
      <rule filter="&quot;dir&quot; = 'TF'" key="{f66f3258-1af8-415e-b2ad-918f2a00b39d}" symbol="1"/>
      <rule filter="&quot;dir&quot; = 'B'" key="{31b3b894-009d-4b90-b9ea-ae813bc78b43}" symbol="2"/>
    </rules>
    <symbols>
